  ...
  return (
    <>
      ...
      <div className="flex border p-3 gap-4 bg-[#DECAFF] mt-4">
        ...
        />
        <div>
          <p className="font-bold text-xl text-[#3C0792]">GABA signaling</p>
          <p className="text-lg">
            ...
            receptor, GPR173, localized in the CCK-GABA synapses and mediated
            the enhancement of the GABA inhibition effect.
          </p>
      ...
      <div className="flex gap-4">
        <div className="border p-3 gap-4 bg-[#DECAFF] mt-4 w-[50%]">
          ...
          />
          <div>
            <p className="font-bold text-2xl text-[#3C0792]">CCK-GABA</p>
            <p className="text-lg">
              We identified a novel CCK receptor, GPR173, localized in the
              CCK-GABA synapses and mediated the enhancement of the GABA
              inhibition effect.
            </p>
